...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/css/isotope.css" media="screen" />
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="index.html"><h1><span>AEC</span> Design Web</h1></a>
                    </div>
                </div>
                ...
                <div class="navbar-collapse collapse">
                    <div class="menu">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="clients.html">Clients</a></li>
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <div class="img-thumbnail">
                        ...
                        <div class="caption">
                            <h3>Titre</h3>
                            <h5>15 décembre 2014</h5>
                            <p>Voluptatem accusantium doloremque laudantium sprea totam rem aperiam. </p>
                            <a href="article.html" class="btn btn-default" role="button">Lire la suite</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="jumbotron">
    <h1>Nous sommes <span>les meilleurs</span> pour vos projets!</h1>
    <p>Voluptatem accusantium doloremque laudantium sprea totam rem aperiam</p>
    <p><a class="btn btn-primary btn-lg" href="#" role="button">Voyez nos services</a></p>
</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 l-posts">
                    <h3 class="widgetheading">Derniers articles</h3>
                    <ul>
