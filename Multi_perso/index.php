...
<?php get_header(); ?>
	...
	<div class="slider">
		<div class="img-responsive">
			<ul class="bxslider">
				<li><img src="<?php bloginfo('template_directory'); ?>/images/slider/1.jpg" alt=""/></li>
				<li><img src="<?php bloginfo('template_directory'); ?>/images/slider/2.jpg" alt=""/></li>
				<li><img src="<?php bloginfo('template_directory'); ?>/images/slider/3.jpg" alt=""/></li>
			</ul>
		</div>
    </div>
